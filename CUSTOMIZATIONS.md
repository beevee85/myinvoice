...
2. **Layout editoru faktury** — „Poznámka pod položkami", „Interní poznámka" a „Sumace" jsou nyní boxy přes celou šířku (dřív grid 2/3+1/3); součty uvnitř Sumace drží vpravo v šířce sloupce (čitelnost dvojic popisek/částka). Dodatek: **Klasifikace přesunuta až ZA Sumaci** (závěrečné zatřídění dokladu).
