...
/**
 * FORK (beevee85): per-user omezení na dodavatele (migrace 0900, user_supplier_access).
 *
...
final class UserSupplierAccessTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        if (!$tableExists) {
            $this->markTestSkipped('Migrace 0900_user_supplier_access neběžela.');
        }
    ...
    private function seed(): void
    {
        ...
        // Druhý supplier: klon prvního (dynamický sloupcový list — nezávislé na schématu),
        // FK cascade při delete uklidí i user_supplier_access.
        $cols = $pdo->query(
